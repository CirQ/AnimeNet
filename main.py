...
def main():
    ...
    # train_loader = DataLoader(train_set, num_workers=opt.threads, batch_size=opt.batch, shuffle=True)
...
lambda_gp = 0.5
def train(train_loader, gen, dis, g_optim, d_optim, criterion, epoch):
    ...
    if opt.cuda:
        X, z, tags, labels = (None for _ in range(4))
